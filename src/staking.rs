...
impl StakeKeeper {
    ...
    fn get_rewards_internal(
        ...
        Ok(Coin {
            ...
            amount: delegator_rewards.to_uint_floor(), // multiplying by 1 to convert Decimal to Uint128
        })
    }
    ...
    fn get_stake(
        ...
        Ok(shares.map(|shares| {
            Coin {
                denom: staking_info.bonded_denom,
                amount: shares.stake.to_uint_floor(), // multiplying by 1 to convert Decimal to Uint128
            }
        }))
    }
    ...
    fn query(
        ...
        match request {
            ...
            StakingQuery::Delegation {
                ...
                let amount = coin(
                    (shares.stake.to_uint_floor()).u128(),
                    staking_info.bonded_denom,
                );
...
impl DistributionKeeper {
    ...
    pub fn remove_rewards(
        ...
        let rewards = shares.rewards.to_uint_floor(); // convert to Uint128
