...
use cosmwasm_std::{
    from_binary, Api, Binary, CustomQuery, IbcEndpoint, IbcOrder, StdError, StdResult, Storage,
};
    ...
    GovT2: Gov,
{
    ...
    let counterparty: Connection =
        from_binary(&src_app.ibc_query(MockIbcQuery::ConnectedChain {
...
where
    ...
    GovT2: Gov,
{
    let packet: IbcPacketData = from_binary(&app1.ibc_query(MockIbcQuery::SendPacket {
