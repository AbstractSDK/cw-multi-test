...
use cosmwasm_std::{
    ensure_eq, to_binary, Addr, BankMsg, Binary, ChannelResponse, Coin, Event, IbcAcknowledgement,
    IbcChannel, IbcChannelConnectMsg, IbcChannelOpenMsg, IbcEndpoint, IbcMsg, IbcOrder, IbcPacket,
            ...
            MockIbcQuery::CosmWasm(m) => {
                match m {
                    ...
                    IbcQuery::ListChannels { port_id } => {
                        ...
                        Ok(to_binary(&ListChannelsResponse {
