...
use cosmwasm_std::{
    coin, coins, from_binary, to_binary, Addr, AllBalanceResponse, Api, BalanceResponse, BankMsg,
    BankQuery, Binary, BlockInfo, Coin, Event, IbcPacketAckMsg, IbcPacketReceiveMsg, Order,
    Querier, StdResult, Storage, SupplyResponse, Uint128,
};
...
impl Module for BankKeeper {
    ...
    fn ibc_packet_receive<ExecC, QueryC>(
        ...
        let packet: Ics20Packet = from_binary(&request.packet.data)?;
